    ...
    <div id="sign-up">
        <div class="firStep">
            ...
            <div class="content">
                ...
                <Button color="linear-gradient(360deg, #162A97 0%, #7971EB 100%)"
                ...
                <van-row type="flex" align="center" justify="center" class="tipsBox">
                    <checkbox v-model="checked" checked-color="linear-gradient(360deg, #162A97 0%, #7971EB 100%)" icon-size="0.38rem" class="checkbox" />
