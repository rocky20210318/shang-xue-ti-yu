        ...
        <Form @submit="onSubmit">
            ...
            <RadioGroup v-model="radio" class="radio">
                <van-row type="flex" align="center" class="">
                    <Radio name="1" checked-color="#FF6600" class="item" icon-size="16px">储蓄卡</Radio>
                    <Radio name="2" checked-color="#FF6600" class="item" icon-size="16px">信用卡</Radio>
                </van-row>
            </RadioGroup>
            ...
            <Button block color="linear-gradient(147deg, #FF9313 0%, #FF6600 100%)" class="Button">验证银行卡</Button>
        </Form>
    </div>
</template>
