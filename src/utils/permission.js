...
function judgeIosPermissionContact () {
    let result = false
    const CNContactStore = window.plus.ios.import('CNContactStore')
    ...
    window.plus.ios.deleteObject(CNContactStore)
    return result
}
...
function judgeIosPermissionCalendar () {
    let result = false
    const EKEventStore = window.plus.ios.import('EKEventStore')
    ...
    window.plus.ios.deleteObject(EKEventStore)
    return result
}
...
function gotoAppPermissionSetting () {
    if (isIos) {
        ...
        // console.log(window.plus.device.vendor)
